...
var creditFormats = map[string]string{
	...
	"it": "Questo episodio è stato narrato da %s, di %s.",
	"de": "Diese Folge wurde von %s gesprochen, bereitgestellt von %s.",
}
...
var expandedCreditFormats = map[string]string{
	...
	"it": "Episodio generato da %s su %s, con la voce di %s, di %s.",
	"de": "Folge erstellt von %s auf %s, gesprochen von %s, bereitgestellt von %s.",
}
